<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar empleados</h2>
</div>
...
<div class="container pb-6 pt-6">
    <?php
        ...
        $insCliente = new empleadoController();
    ...
    <?php
            echo $insCliente->listarempleadoControlador($url[1],15,$url[0],$_SESSION[$url[0]]);
        }
    ?>
</div>